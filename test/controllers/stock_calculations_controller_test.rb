...
class StockCalculationsControllerTest < ActionController::TestCase
  ...
  test "should create stock_calculation" do
    assert_difference('StockCalculation.count') do
      post :create, stock_calculation: { name: @stock_calculation.name, percentage: @stock_calculation.percentage, price: @stock_calculation.price, quantity: @stock_calculation.quantity, years: @stock_calculation.years }
    end
  ...
  test "should update stock_calculation" do
    patch :update, id: @stock_calculation, stock_calculation: { name: @stock_calculation.name, percentage: @stock_calculation.percentage, price: @stock_calculation.price, quantity: @stock_calculation.quantity, years: @stock_calculation.years }
    assert_redirected_to stock_calculation_path(assigns(:stock_calculation))
  end
